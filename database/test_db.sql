...
INSERT INTO account VALUES (SEQ_ACCOUNT_ID.nextval, '670100/2216739313/6210', 'CZ5262106701002216739313', 2999.00, 0, 5, 3, 2, 2, 2);
...
SELECT TYPE_NAME, COUNT(*) as Accounts_count FROM ACCOUNT_TYPE NATURAL JOIN ACCOUNT GROUP BY TYPE_NAME;
